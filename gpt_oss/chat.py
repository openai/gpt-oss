...
from gpt_oss.tools.simple_browser.backend import YouComBackend, ExaBackend, ParallelBackend
...
def main(args):
    ...
    if args.browser:
        ...
        if tool_backend == "parallel":
            ...
            raise ValueError(f"Invalid browser backend: {tool_backend}")
